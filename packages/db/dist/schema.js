...
exports.drawsTable = (0, pg_core_1.pgTable)("draw", {
    ...
    lineWidth: (0, pg_core_1.real)("lineWidth").notNull(),
    font: (0, pg_core_1.text)("font"),
    fontSize: (0, pg_core_1.text)("fontSize"),
    startX: (0, pg_core_1.real)("startX"),
    startY: (0, pg_core_1.real)("startY"),
    endX: (0, pg_core_1.real)("endX"),
    endY: (0, pg_core_1.real)("endY"),
